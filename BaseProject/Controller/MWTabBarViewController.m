...
- (void)viewDidLoad {
    ...
    vc.title = @"美图";
    vc.tabBarItem.image = [[UIImage imageNamed:@"美图 2"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    vc.tabBarItem.selectedImage = [[UIImage imageNamed:@"13"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    self.tabBarController.modalPresentationStyle = UIModalPresentationCustom;
}
